...
define config.name = _("I WILL TAKE YOU THROUGH THE WIND")
...
define build.name = "IWillTakeYouThroughtheWind"
...
define config.save_directory = "IWillTakeYouThroughtheWind-1762238845"
