...
transform fade_in_video:
    alpha 0.0             # bắt đầu trong suốt
    linear 1.0 alpha 1.0  # fade in trong 1 giây
screen main_menu():
    ## This ensures that any other menu screen is replaced.
    tag menu
    add Movie(size=(1280, 720), play="video/media.webm", loop=True) at fade_in_video
